...
# InterMine 2019 GSoC project ideas

_**Guidance:**_ 

- _Please copy and paste the template below to add your own ideas._ 
- _You can also express interest in a project by adding your name to the list of mentors._
...
**Description**: Short description of project - 2-5 sentences
...
- Name of Mentor, (((OPTIONAL: Mentor email address HERE))).
- Mentor 2 (add more if needed) 

You can find the mentors in the [InterMine chat](http://chat.intermine.org). 


**Expected outcome:** What do we want at the end of the project? How could this integrate with existing InterMine tools, e.g. BlueGenes, InterMine Server.
**How could this integrate with existing InterMine tools?** e.g. BlueGenes, InterMine Server.
**Difficulty level:** Medium if student knows x, easier if student knows x, y. 
